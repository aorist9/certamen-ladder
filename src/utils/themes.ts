    ...
    components: {
      ...
      MuiPaper: {
        styleOverrides: {
          root: {
            ...
            border: `1px solid ${options.mode === "light" ? "rgba(15, 23, 42, 0.12)" : "rgba(255, 255, 255, 0.12)"}`,
            borderRadius: 16,
            boxShadow: options.mode === "light" ? "0 1px 3px rgba(15, 23, 42, 0.08)" : "0 8px 24px rgba(2, 6, 23, 0.25)"
          }
        }
      },
      MuiButton: {
        styleOverrides: {
          ...
          outlined: {
            borderColor: options.mode === "light" ? "rgba(15, 23, 42, 0.2)" : "rgba(255, 255, 255, 0.2)"
          }
        }
      },
      MuiTextField: {
      ...
      MuiOutlinedInput: {
        styleOverrides: {
          root: {
            borderRadius: 12,
            backgroundColor: options.mode === "light" ? "#f8fafc" : "rgba(255,255,255,0.04)"
          },
          input: {
            color: options.textPrimary
          }
        }
      },
      MuiInputLabel: {
